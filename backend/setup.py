...
clinical=pd.read_csv('C:\\Users\\Sai\\Desktop\\GDCPMT\\backend\\EXAMPLE_DATA\\clinical_data\\clinical.tsv',sep='\t')
...
mutations = pd.read_excel('C:\\Users\\Sai\\Desktop\\GDCPMT\\backend\\EXAMPLE_DATA\\mutations_data\\mutations1.xlsx')
#mutations.columns.name = mutations

#radiationinfo = pd.read_csv('./clinical_data/radiationinfo.tsv',delimiter='/t')
slides = pd.read_excel("C:\\Users\\Sai\\Desktop\\GDCPMT\\backend\\biospecimen\\slides_gleaned.xlsx")
treatment_data = pd.ExcelFile('C:\\Users\\Sai\\Desktop\\GDCPMT\\backend\\EXAMPLE_DATA\\clinical_data\\treatment_data.xlsx')
pharmaceutical_treatment_data = pd.read_excel("C:\\Users\\Sai\\Desktop\\GDCPMT\\backend\\EXAMPLE_DATA\\clinical_data\\all_clinicaL_drug_info.xlsx")

with open('C:\\Users\\Sai\\Desktop\\GDCPMT\\backend\\EXAMPLE_DATA\\\\mutations_data\\patmut.csv','r',encoding='utf-8',newline='') as patmutcsv:
