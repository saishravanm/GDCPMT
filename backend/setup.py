...
clinical=pd.read_csv('C:\\Users\\saish\\Documents\\GitHub\\GDCPMT\\backend\\EXAMPLE_DATA\\clinical_data\\clinical.tsv',sep='\t')
...
mutations = pd.read_excel('C:\\Users\\saish\\Documents\\GitHub\\GDCPMT\\backend\\EXAMPLE_DATA\\mutations_data\\mutations1.xlsx')
#mutations.columns.name = mutations

#radiationinfo = pd.read_csv('./clinical_data/radiationinfo.tsv',delimiter='/t')
slides = pd.read_excel("C:\\Users\\saish\\Documents\\GitHub\\GDCPMT\\backend\\biospecimen\\slides_gleaned.xlsx")
treatment_data = pd.ExcelFile('C:\\Users\\saish\\Documents\\GitHub\\GDCPMT\\backend\\EXAMPLE_DATA\\clinical_data\\treatment_data.xlsx')
pharmaceutical_treatment_data = pd.read_excel("C:\\Users\\saish\\Documents\\GitHub\\GDCPMT\\backend\\EXAMPLE_DATA\\clinical_data\\all_clinicaL_drug_info.xlsx")

p53_list = pd.read_csv("C:\\Users\\saish\\Documents\\GitHub\\GDCPMT\\backend\\EXAMPLE_DATA\\clinical_data\\p53_patients.tsv",delimiter='\t')
pik3ca_list = pd.read_csv("C:\\Users\\saish\\Documents\\GitHub\\GDCPMT\\backend\\EXAMPLE_DATA\\clinical_data\\pik3ca_patients.tsv",delimiter='\t')

with open('C:\\Users\\saish\\Documents\\GitHub\\GDCPMT\\backend\\EXAMPLE_DATA\\mutations_data\\patmut.csv','r',encoding='utf-8',newline='') as patmutcsv:
